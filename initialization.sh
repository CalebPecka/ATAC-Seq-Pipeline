...
conda install -c bioconda bioconductor-zlibbioc
conda install -c bioconda bioconductor-xvector
R -e 'install.packages("https://cran.r-project.org/src/contrib/Archive/crayon/crayon_1.3.4.tar.gz", repos = NULL, type = "source")'
conda install -c bioconda bioconductor-biostrings
conda install -c bioconda bioconductor-bcrank
R -e 'install.packages("https://cran.r-project.org/src/contrib/Archive/pixmap/pixmap_0.4-11.tar.gz", repos = NULL, type = "source")'
R -e 'install.packages("https://cran.r-project.org/src/contrib/Archive/sp/sp_1.4-2.tar.gz", repos = NULL, type = "source")'
